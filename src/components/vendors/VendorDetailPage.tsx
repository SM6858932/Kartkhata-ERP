...
import { User, Vendor, Cart, RentAgreement, Payment, isOwnerRole } from '../../types';
            ...
            <div className="px-4 py-4 space-y-5 max-w-2xl mx-auto">
                ...
                <div className="space-y-3">
                    <div className="flex items-center justify-between gap-2 flex-wrap">
                        ...
                        <div className="flex items-center gap-2">
                            {onReturnCart && cart && cart.status === 'rented' && isOwnerRole(currentUser.role) && (
                                <button
                            ...
                            <button
                                onClick={() => { void exportVendorPDFStatement(summary, payments, company ?? undefined); }}
