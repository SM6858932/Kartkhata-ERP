...
import { calculateVendorLedger, VendorLedgerSummary, exportVendorPDFStatement, generateWhatsAppReceiptUrl } from '../../utils/ledger';
import { 
  Wallet, Search, Filter, Download, MessageSquare, IndianRupee, 
  CheckCircle2, AlertCircle, Clock, FileText, ArrowUpRight, ArrowDownRight 
} from 'lucide-react';
...
export const LedgerTab: React.FC<LedgerTabProps> = ({
  ...
  const visibleVendors = currentUser.role === 'collector'
            ...
            return (
              ...
              >
                ...
                <div className="grid grid-cols-4 gap-2 p-3 rounded-xl border text-center mb-3 bg-slate-50 border-slate-200 dark:bg-slate-950/70 dark:border-slate-800">
                  ...
                  <div>
                    ...
                    <span className={`text-xs font-black ${
                      balanceRemaining > 0 ? 'text-rose-500' : 'text-emerald-500'
                    }`}>
                ...
                <div className="flex items-center justify-between gap-2" onClick={e => e.stopPropagation()}>
                  ...
                  {lastPayment && (
                    <a
                      href={generateWhatsAppReceiptUrl(vendor.phone, vendor.fullName, lastPayment, cart ? cart.cartNumber : 'N/A')}
                      target="_blank"
